...
public class Graph<E extends AbstractEdge<E>> implements Serializable {
    ...
    public final HashMap<Long, E> edges = new HashMap<>();
    ...
    public Graph<E> construct() {
        //Map<起点标识source，以该起点标识发射出的所有边edges>
        ...
        for (ArrayList<E> edges : map.values()) {
            for (int i = 1; i < edges.size(); ++i) {
                //将edges中的下一条边作为自己的邻边，并且将以自己的起点为终点target的边集中的第一条边作为前导边
