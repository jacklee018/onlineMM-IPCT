...
import MapMatchBaseline.STMatching.EnhanceSTMatcher3_S
 ...
 */
object BaselineMatchTest2_EnhanceST3_S {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println("EnhanceSTMatcher3_S")
    val matcherBC: Broadcast[ClientMapMatcher[EnhanceSTMatcher3_S]] = sc.broadcast(new ClientMapMatcher[EnhanceSTMatcher3_S](mapPath, 50, classOf[EnhanceSTMatcher3_S]))
    ...
    rate.foreach(t => {
      ...
      println(EnhanceSTMatcher3_S.candsNum.get(), EnhanceSTMatcher3_S.sampleNum.get())
      val candsNum = EnhanceSTMatcher3_S.candsNum.get() - accuCandsNum
      val sampleNum = EnhanceSTMatcher3_S.sampleNum.get() - accuSampleNum
      accuCandsNum = EnhanceSTMatcher3_S.candsNum.get()
      accuSampleNum = EnhanceSTMatcher3_S.sampleNum.get()
  ...
  def doBfMatch(gpsDataArray: mutable.Buffer[Array[String]], matcher: ClientMapMatcher[EnhanceSTMatcher3_S]): Tuple3[Int, Int, Long] = {
