...
import MapMatchBaseline.STMatching.EnhanceSTMatcher3
 ...
 */
object BaselineMatchTest2_EnhanceST3 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println("EnhanceSTMatcher3")
    val matcherBC: Broadcast[ClientMapMatcher[EnhanceSTMatcher3]] = sc.broadcast(new ClientMapMatcher[EnhanceSTMatcher3](mapPath, 50, classOf[EnhanceSTMatcher3]))
    ...
    rate.foreach(t => {
      ...
      println(EnhanceSTMatcher3.candsNum.get(), EnhanceSTMatcher3.sampleNum.get())
      val candsNum = EnhanceSTMatcher3.candsNum.get() - accuCandsNum
      val sampleNum = EnhanceSTMatcher3.sampleNum.get() - accuSampleNum
      accuCandsNum = EnhanceSTMatcher3.candsNum.get()
      accuSampleNum = EnhanceSTMatcher3.sampleNum.get()
  ...
  def doBfMatch(gpsDataArray: mutable.Buffer[Array[String]], matcher: ClientMapMatcher[EnhanceSTMatcher3]): Tuple3[Int, Int, Long] = {
