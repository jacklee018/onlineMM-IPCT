...
import MapMatchBaseline.HMMM.EnhanceHMMMatcher_S
 ...
 */
object BaselineMatchTest2_EHMM_S {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println("EnhanceHMMMatcher_S ")
    val matcherBC: Broadcast[ClientMapMatcher[EnhanceHMMMatcher_S]] = sc.broadcast(new ClientMapMatcher[EnhanceHMMMatcher_S](mapPath, 50, classOf[EnhanceHMMMatcher_S]))
    ...
    rate.foreach(t => {
      ...
      println(EnhanceHMMMatcher_S.candsNum.get(), EnhanceHMMMatcher_S.sampleNum.get())
      val candsNum = EnhanceHMMMatcher_S.candsNum.get() - accuCandsNum
      val sampleNum = EnhanceHMMMatcher_S.sampleNum.get() - accuSampleNum
      accuCandsNum = EnhanceHMMMatcher_S.candsNum.get()
      accuSampleNum = EnhanceHMMMatcher_S.sampleNum.get()
  ...
  def doBfMatch(gpsDataArray: mutable.Buffer[Array[String]], matcher: ClientMapMatcher[EnhanceHMMMatcher_S]): Tuple3[Int, Int, Long] = {
