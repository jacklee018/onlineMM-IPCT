...
import MapMatchBaseline.HMMM.EnhanceHMMMatcher_O
 ...
 */
object BaselineMatchTest2_EHMM_O {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println("EnhanceHMMMatcher_O ")
    val matcherBC: Broadcast[ClientMapMatcher[EnhanceHMMMatcher_O]] = sc.broadcast(new ClientMapMatcher[EnhanceHMMMatcher_O](mapPath, 50, classOf[EnhanceHMMMatcher_O]))
    ...
    rate.foreach(t => {
      ...
      println(EnhanceHMMMatcher_O.candsNum.get(), EnhanceHMMMatcher_O.sampleNum.get())
      val candsNum = EnhanceHMMMatcher_O.candsNum.get() - accuCandsNum
      val sampleNum = EnhanceHMMMatcher_O.sampleNum.get() - accuSampleNum
      accuCandsNum = EnhanceHMMMatcher_O.candsNum.get()
      accuSampleNum = EnhanceHMMMatcher_O.sampleNum.get()
  ...
  def doBfMatch(gpsDataArray: mutable.Buffer[Array[String]], matcher: ClientMapMatcher[EnhanceHMMMatcher_O]): Tuple3[Int, Int, Long] = {
